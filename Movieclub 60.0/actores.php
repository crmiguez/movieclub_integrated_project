...
<div id="content">
  <div align="center">
  <?php
		//Consultamos todos/as actores/actrices de la base de datos y las ordenamos alfabéticamente por el nombre artístico
		$actoresbasedatos=conexion("SELECT * FROM actores ORDER BY nombre_artistico ASC");
		$totalbdactores=mysql_num_rows($actoresbasedatos); //Contamos las filas
	echo "<p align=\"center\" class=\"style13\">Actores en total: $totalbdactores </p>";	  //Mostramos el total de actores que hay en la base de datos
?>
  <table width="100%" border="1" align="center" bordercolor="#996600" bgcolor="#CCCCCC">
    <tr>
      <th scope="col"><div align="center">
        <?php
	//Mientras exista la consulta, rellenamos los datos, rellenamos todo lo referente a la información reducida
	//de los actores y actrices de la base de datos
	while($datosactores=mysql_fetch_array($actoresbasedatos)){
	echo "
	<table width=\"90%\" border=\"2\">";
    echo "<tr><td width=\"37%\" bgcolor=\"#99FFCC\"><div align=\"center\"><b>Foto:</b></td>";
	echo "<td><div align=\"center\"><img src=\"".$datosactores["foto"]."\" width=\"300\" height=\"300\" /></td></tr>";
    echo "<tr><td width=\"37%\" bgcolor=\"#99FFCC\"><div align=\"center\"><b>Nombre Artístico:</b></td>";
	echo"<td><a href=\"informacion-extendida-actor.php?id=".$datosactores["id"]."\">".$datosactores["nombre_artistico"]."</a></td></tr>";
	echo "<tr><td width=\"37%\" bgcolor=\"#99FFCC\"><div align=\"center\"><b>Nombre Real:</b></td><td>".$datosactores["nombre_real"]."</td></tr>";
	echo "<tr><td width=\"37%\" bgcolor=\"#99FFCC\"><div align=\"center\"><b>Biografía:</b><td>".$datosactores["biografia"]."</td>";
    echo "</table>";
	echo"<p>&nbsp;</p>";	
	}
