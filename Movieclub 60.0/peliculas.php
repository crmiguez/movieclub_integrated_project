...
<title>Movieclub, tu tienda de peliculas:: Peliculas</title>
...
<div id="content">
  <div align="center" class="style13">
	<?php
		//Consultamos todas las películas de la base de datos y las ordenamos por título
		$pelisbasedatos=conexion("SELECT peliculas.*, nombre FROM peliculas INNER JOIN generos ON generos.id=peliculas.id_genero ORDER BY titulo ASC");
		$totalbd=mysql_num_rows($pelisbasedatos); //Contamos las filas
	echo "Peliculas en total: $totalbd </p>";	  //Mostramos el total de películas que hay en la base de datos
?>
	...
	while($datos=mysql_fetch_array($pelisbasedatos)){
	echo "<table width=\"90%\" border=\"2\">";
    echo "<tr><td width=\"37%\" bgcolor=\"#99FFCC\"><div align=\"center\"><b>Cartel:</b></td>";
	echo "<td><div align=\"center\"><img src=\"".$datos["cartel"]."\" width=\"300\" height=\"300\" /></td></tr>";
    echo "<tr><td width=\"37%\" bgcolor=\"#99FFCC\"><div align=\"center\"><b>Título:</b></td>";
	echo"<td><a href=\"informacion-extendida.php?id=".$datos["id"]."\">".$datos["titulo"]."</a></td></tr>";
    echo "<tr><td width=\"37%\" bgcolor=\"#99FFCC\"><div align=\"center\"><b>Año:</b></td><td>".$datos["anho"]."</td></tr>";
    echo "<tr><td width=\"37%\" bgcolor=\"#99FFCC\"><div align=\"center\"><b>Género:</b></td><td>".$datos["nombre"]."</td></tr>";
    echo "<tr><td width=\"37%\" bgcolor=\"#99FFCC\"><div align=\"center\"><b>Clasificación:</b></td><td>".$datos["clasificacion"]."</td></tr>";
	echo "<tr><td width=\"37%\" bgcolor=\"#99FFCC\"><b>Argumento</b></td><td>".$datos["argumento"]."</td></tr>";
	echo "<tr><td width=\"37%\" bgcolor=\"#99FFCC\"><b>Trailer</b></td><td><object width=\"560\" height=\"349\"><param name=\"movie\" value=\"".$datos["trailer"]."\"></param><param name=\"allowFullScreen\" value=\"true\"></param><param name=\"allowscriptaccess\" value=\"always\"></param><embed src=\"".$datos["trailer"]."\" type=\"application/x-shockwave-flash\" allowscriptaccess=\"always\" allowfullscreen=\"true\" width=\"560\" height=\"349\"></embed></object></td></tr>";
    echo "</table>";
	echo"<p>&nbsp;</p>";
	echo"<p>&nbsp;</p>";	
	}
